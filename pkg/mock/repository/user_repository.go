...
func (m *MockUserReader) Find(userID string) (entity.User, error) {
	m.ctrl.T.Helper()
...
// Find mocks base method.
func (m *MockUserReaderWriter) Find(userID string) (entity.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Find", userID)
	ret0, _ := ret[0].(entity.User)
	ret1, _ := ret[1].(error)
...
func (m *MockStats) CountFollowers(userID string) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockStats) CountFollowing(userID string) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockStats) CountPosts(userID string) (int64, error) {
	m.ctrl.T.Helper()
